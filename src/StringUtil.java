...
public class StringUtil {
	...
	public static String replace(String inputStr, int length) {
		...
		char[] outputStr=new char[newLength];
		// str[newLength] = '\0';
		for (i = length - 1; i >= 0; i--) {
			if (str[i] == ' ') {
				outputStr[newLength - 1] = '0';
				outputStr[newLength - 2] = '2';
				outputStr[newLength - 3] = '%';
				newLength = newLength - 3;
			} else {
				outputStr[newLength - 1] = str[i];
